...
//         { path: "/user/practice", label: "Practice Questions", icon: FiGrid },
//         { path: "/user/result", label: "Performance Analysis", icon: FiBarChart2 },
//         { path: "/user/notification", label: "Communication and Support", icon: FiUsers },
...
//                         //   <div>
//                         //   {notifications?.notifications.map((notif, index) => (
//                         //     <div key={index} className="py-1 text-sm">{notif.message}</div>
//                         //   ))}
//                         // </div>
//                         ))}
//                       </div>
